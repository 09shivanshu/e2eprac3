...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,)-> artifact_entity.ModelTrainerArtifact:
        try:
            ...
            train_arr = utils.load_numpy_array_data(file_path = self.data_transformation_artifact.transform_test_path)
            ...
            model_trainer_artifact = artifact_entity.ModelTrainerArtifact(self.model_trainer_config.model_path, 
